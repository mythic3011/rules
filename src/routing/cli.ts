...
function usage(): string {
  return "Usage: tsx src/routing/cli.ts ... | materialize-private <manifest-directory> <projection-file> <candidate-file> <deployment-json> <approved-egress-json> <private-output>";
}
