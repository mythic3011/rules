...
This reads the local bundle hash, fetches only small signed release metadata plus its detached signature, verifies the local trust anchor, and compares hashes. It never installs, reconciles, refreshes, or executes fetched bytes.
