...
- `setup/openclash/scripts/setup_adblock_cron.sh`
...
```bash
python3 internal/python/generate_adblock_outputs.py
```

Then verify:

```bash
python3 -m py_compile internal/python/generate_adblock_outputs.py
sh -n setup/openclash/scripts/apply_adblock_dnsmasq.sh setup/openclash/scripts/setup_adblock_cron.sh
git diff --stat
```
...
- `internal/config/filtering/sources/custom/<category>.yaml`
- `internal/config/filtering/seeds/<category>-lite.txt`
...
wget -qO- "https://testingcf.jsdelivr.net/gh/mythic3011/rules@refs/heads/${RULES_BRANCH}/setup/openclash/scripts/apply_adblock_dnsmasq.sh" | sh
```
...
```bash
RULES_BRANCH="${RULES_BRANCH:-main}"
wget -qO- "https://testingcf.jsdelivr.net/gh/mythic3011/rules@refs/heads/${RULES_BRANCH}/setup/openclash/scripts/setup_adblock_cron.sh" | sh
```
